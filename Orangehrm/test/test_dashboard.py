...
#this part test if the widgets of quick launch works and leads to a right directory or page
    ...
    def test_subunit_toggle(self, driver):
        ...
        # Click all legend items
        panel.find_element(By.XPATH,
                           '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[6]/div/div[2]/div/ul/li[1]/span[2]').click()
        panel.find_element(By.XPATH,
                           '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[6]/div/div[2]/div/ul/li[2]/span[2]').click()
        panel.find_element(By.XPATH,
                           '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[6]/div/div[2]/div/ul/li[3]/span[2]').click()
        panel.find_element(By.XPATH,
                           '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[6]/div/div[2]/div/ul/li[4]/span[2]').click()
        panel.find_element(By.XPATH,
                           '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[6]/div/div[2]/div/ul/li[5]/span[2]').click()

        time.sleep(2)

        visible_paths = driver.find_elements(By.XPATH, '//*[@id="mPr4nsxc"]//*[name()="path"][@opacity!="0"]')
        assert len(visible_paths) == 0, f"Expected 0 visible chart segments, but found {len(visible_paths)}"

        print("✓ Chart has no visible segments")
    ...
    def test_location_toggle(self, driver):
        ...
        visible_paths = driver.find_elements(By.XPATH, '//*[@id="VJD856Bf"]//*[name()="path"][@opacity!="0"]')
        assert len(visible_paths) == 0, f"Expected 0 visible chart segments, but found {len(visible_paths)}"
    ...
    def test_on_leave_configuration(self, driver):
        ...
        config_modal = driver.find_element(By.XPATH, "//*[contains(text(),'Configurations')]")
